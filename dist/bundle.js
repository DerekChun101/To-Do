...
const loadHome = () => {
    ...
    whichTab = 'home'
    console.log();
    (0,_task__WEBPACK_IMPORTED_MODULE_0__.createTaskList)(_task__WEBPACK_IMPORTED_MODULE_0__.tasksArray);
    (0,_project__WEBPACK_IMPORTED_MODULE_1__.createProjectList)(_project__WEBPACK_IMPORTED_MODULE_1__.projectArray);
}
const loadToday = () => {
    mainHeader.innerHTML = '';
...
const loadProject = (name) => {
    ...
    whichTab = 'project';
    (0,_task__WEBPACK_IMPORTED_MODULE_0__.createTaskList)(_project__WEBPACK_IMPORTED_MODULE_1__.projectArray[currentId].tasks)
}
const createTaskDom = (task, id ) => {
    ...
    removeButton.addEventListener('click', () => {
        ...
        (0,_savedata__WEBPACK_IMPORTED_MODULE_2__.saveTasks)(_task__WEBPACK_IMPORTED_MODULE_0__.tasksArray);
...
function displayTask (taskCard) {
    const thisWeek = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.add)(new Date(), {
        days: 7
    });
...
function formatTheDate (date) {
    ...
    return (0,date_fns__WEBPACK_IMPORTED_MODULE_4__.format)(new Date(
            year,
            (month - 1),
            day,
    ), 'M-dd-yyyy')
...
const createProjectDom = (project, id) => {
    ...
    removeProject.addEventListener('click', () => {
        ...
        (0,_project__WEBPACK_IMPORTED_MODULE_1__.createProjectList)(_project__WEBPACK_IMPORTED_MODULE_1__.projectArray);
        (0,_savedata__WEBPACK_IMPORTED_MODULE_2__.saveProjects)(_project__WEBPACK_IMPORTED_MODULE_1__.projectArray);
        loadHome();
    })
}
...
const createProject = () => {
   ...
   (0,_savedata__WEBPACK_IMPORTED_MODULE_1__.saveProjects)(projectArray);
...
const createProjectList = (projects) => {
    ...
    for(let i = 0; i < projects.length; i++) {
        let id = i;
        (0,_dom__WEBPACK_IMPORTED_MODULE_0__.createProjectDom)(projects[i], id);
    }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   loadProjectsData: () => (/* binding */ loadProjectsData),
...
const addTask = () => {
    ...
    if(_dom__WEBPACK_IMPORTED_MODULE_0__.whichTab === 'project') {
        ...
        ;(0,_project__WEBPACK_IMPORTED_MODULE_1__.addTaskToProject)(task, id);
        createTaskList(_project__WEBPACK_IMPORTED_MODULE_1__.projectArray[_dom__WEBPACK_IMPORTED_MODULE_0__.currentId].tasks);
        return
    }
...
/* harmony import */ var _savedata__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./savedata */ "./src/savedata.js");
